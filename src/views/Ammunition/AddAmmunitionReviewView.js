...
import { createAmmoReview } from "../../services/ammunitionReviewService";
import "../../styles/AddReviewView.css";
const AddAmmunitionReviewView = () => {
  const { id } = useParams();
  ...
  const handleSubmit = async (event) => {
    ...
    await createAmmoReview(review);
    navigate(`/ammunitionReviews/${id}`);
  };
...
export default AddAmmunitionReviewView;
